...
/* HELP */
static struct kobj_attribute _help = __ATTR_RO_MODE(help, 0440);
...
static struct kobj_attribute tree_health_check_provider
	= __ATTR(tree_health_check_provider, 0640,
		tree_health_check_provider_show, tree_health_check_provider_store);
