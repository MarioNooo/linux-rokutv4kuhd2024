...
static int mtu3_device_enable(struct mtu3 *mtu)
{
	...
	mtu3_setbits(ibase, SSUSB_U2_CTRL(0),
		(SSUSB_U2_PORT_RG_IDDIG | SSUSB_U2_PORT_FORCE_IDDIG 
		| SSUSB_U2_PORT_OTG_PWRCTL_HSEL | SSUSB_U2_PORT_OTG_SEL));
#else
...
#ifdef CONFIG_USB_MTK_DTV_XHCI
void ssusb_device_resume_tv(struct ssusb_mtk *ssusb)
{
