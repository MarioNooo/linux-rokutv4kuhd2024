...
//	 protocol_type, Headcode, IRSpeed ,enable
	{IR_TYPE_NEC, NUM_KEYMAP_ROKU_TV, 0, 1},
	{IR_TYPE_RC5,NUM_KEYMAP_ROKU_TV,0,0},		// RC5 customer code
	{IR_TYPE_RC6,NUM_KEYMAP_ROKU_TV,0,1}, //Kathrein RC6 customer code
	{IR_TYPE_SHARP, NUM_KEYMAP_ROKU_TV, 0, 1},	//Sharp IR customer code1
};
#else
//Add & Modify Customer IR with Differ Headcode Here
static struct IR_Profile_s ir_config[IR_SUPPORT_NUM] = {
