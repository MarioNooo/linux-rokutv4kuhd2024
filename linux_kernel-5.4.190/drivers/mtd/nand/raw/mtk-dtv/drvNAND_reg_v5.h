...
#define NC_RDATA_DMA_ADR2     GET_REG_ADDR(FCIE_REG_BASE_ADDR, 0x5B)
#define NC_WDATA_DMA_ADR2     GET_REG_ADDR(FCIE_REG_BASE_ADDR, 0x5B)
#define NC_RSPARE_DMA_ADR2    GET_REG_ADDR(FCIE_REG_BASE_ADDR, 0x5C)
#define NC_WSPARE_DMA_ADR2    GET_REG_ADDR(FCIE_REG_BASE_ADDR, 0x5C)
...
#define NC_WBUF_CIFD_ADDR(u16_pos)   GET_REG_ADDR(FCIE_NC_WBUF_CIFD_BASE, u16_pos)
#define NC_RBUF_CIFD_ADDR(u16_pos)   GET_REG_ADDR(FCIE_NC_RBUF_CIFD_BASE, u16_pos)
