...
//-----------------------------------------------------------------------------
struct st_dovi_reg_hprotect_param_in {
	bool is_enable;
	uint16_t width;
	uint16_t height;
};

struct st_dovi_reg_hprotect_param_out {
...
//-----------------------------------------------------------------------------
extern int drv_hwreg_pq_dovi_hprotect_enable(
	struct st_dovi_reg_hprotect_param_in *param_in,
	struct st_dovi_reg_hprotect_param_out *param_out);
