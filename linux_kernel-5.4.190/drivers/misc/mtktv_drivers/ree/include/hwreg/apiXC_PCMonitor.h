...
/// @return MS_BOOL
//-------------------------------------------------------------------------------------------------
MS_BOOL SYMBOL_WEAK MApi_XC_PCMonitor_Init(MS_U8 u8MaxWindowNum);
//-------------------------------------------------------------------------------------------------
/// PC monitor restart
/// @ingroup PC_Monitor_FEATURE
/// @param  eWindow                 \b IN: window ID
//-------------------------------------------------------------------------------------------------
void SYMBOL_WEAK MApi_XC_PCMonitor_Restart(SCALER_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
XC_PCMONITOR_STATUS SYMBOL_WEAK MApi_XC_PCMonitor(INPUT_SOURCE_TYPE_t src, SCALER_WIN eWindow);
...
/// @return XC_PCMONITOR_STATUS
//-------------------------------------------------------------------------------------------------
XC_PCMONITOR_STATUS SYMBOL_WEAK MApi_XC_PCMonitor_GetCurrentState(SCALER_WIN eWindow);
...
/// @return MS_U8
//-------------------------------------------------------------------------------------------------
MS_U8 SYMBOL_WEAK MApi_XC_PCMonitor_GetSyncStatus(SCALER_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
MS_U32 SYMBOL_WEAK MApi_XC_PCMonitor_Get_HFreqx1K(SCALER_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
/// Get vertical frequency * 10 without delay
/// @ingroup PC_Monitor_ToBeModified
/// @param  eWindow                 \b IN: which window we are going to get
/// @param  eType                     \b IN: which method is used to obtain vfreq
/// @return MS_U16 vertical frequency * 10
//-------------------------------------------------------------------------------------------------
MS_U16 SYMBOL_WEAK MApi_XC_PCMonitor_Get_VFreqx10NoDelay(SCALER_WIN eWindow, EN_XC_PCMONITOR_VFREQ_CHECKING_TYPE eType);

//-------------------------------------------------------------------------------------------------
/// Get vertical frequency * 1000 without delay
/// @ingroup PC_Monitor_ToBeModified
/// @param  eWindow                 \b IN: which window we are going to get
/// @param  eType                     \b IN: which method is used to obtain vfreq
/// @return MS_U32 vertical frequency * 1000
//-------------------------------------------------------------------------------------------------
MS_U32 SYMBOL_WEAK MApi_XC_PCMonitor_Get_VFreqx1KNoDelay(SCALER_WIN eWindow, EN_XC_PCMONITOR_VFREQ_CHECKING_TYPE eType);
...
//-------------------------------------------------------------------------------------------------
MS_U16 SYMBOL_WEAK MApi_XC_PCMonitor_Get_Vtotal(SCALER_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
void SYMBOL_WEAK MApi_XC_PCMonitor_Get_Dvi_Hdmi_De_Info(SCALER_WIN eWindow,MS_WINDOW_TYPE* msWin);
...
/// @return MS_BOOL
//-------------------------------------------------------------------------------------------------
MS_BOOL SYMBOL_WEAK MApi_XC_PCMonitor_InvalidTimingDetect(MS_BOOL bPollingOnly, SCALER_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
E_APIXC_ReturnValue SYMBOL_WEAK MApi_XC_PCMonitor_SetTimingCountEx( INPUT_SOURCE_TYPE_t eCurrentSrc, MS_U16 u16TimingStableCounter, MS_U16 u16TimingNosyncCounter);
