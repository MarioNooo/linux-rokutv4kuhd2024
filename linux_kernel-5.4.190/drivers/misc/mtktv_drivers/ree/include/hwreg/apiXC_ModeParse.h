...
/// @return @ref MS_BOOL
//-------------------------------------------------------------------------------------------------
MS_BOOL SYMBOL_WEAK MApi_XC_ModeParse_Init(void);
// mode search
...
/// @return @ref XC_MODEPARSE_RESULT
//-------------------------------------------------------------------------------------------------
XC_MODEPARSE_RESULT SYMBOL_WEAK MApi_XC_ModeParse_MatchModeEx(MS_PCADC_MODETABLE_TYPE_EX* ModeDB, MS_U8 u16NumberOfItems , XC_MODEPARSE_INPUT_INFO *psInputInfo);
#ifdef __cplusplus
}
#endif
