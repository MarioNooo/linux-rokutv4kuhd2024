...
{
	//pr_info("\033[1;34;47m[IO] \033[0m[%s][%d] reg32=%x\n", __func__, __LINE__, (*((volatile uint16_t*)reg32)));
...
{
	//pr_info("\033[1;34;47m[IO] \033[0m[%s][%d] reg32=%x val16=%x\n", __func__, __LINE__, reg32, val16);
	...
	*((volatile uint16_t*)reg32) = val16;
	...
	//pr_info("\033[1;34;47m[IO] \033[0m[%s][%d] reg32=%x val16=%x done\n", __func__, __LINE__, reg32, val16);
}
