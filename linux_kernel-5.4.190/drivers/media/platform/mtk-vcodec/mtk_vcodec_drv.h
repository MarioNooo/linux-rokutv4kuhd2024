...
#include <linux/mtk-v4l2-vdec.h>
#include <linux/mtk-v4l2-venc.h>
...
enum mtk_encode_param {
	...
	MTK_ENCODE_PARAM_VIDEO_QUALITY = (1 << 16)
};
...
enum venc_yuv_fmt {
	...
	VENC_YUV_FORMAT_32bitRGBA1010102_AFBC = 22,
	VENC_YUV_FORMAT_MT10 = 23,
	VENC_YUV_FORMAT_P010 = 24,
	VENC_YUV_FORMAT_NV12_AFBC = 25,
	VENC_YUV_FORMAT_NV12_10B_AFBC = 26,
};
...
struct mtk_enc_params {
	...
	unsigned int    svp_mode;
	struct mtk_video_quality video_quality;
};
...
struct mtk_vcodec_ctx {
	...
	bool dec_res_in_counter;
	bool runtime_decide_hw;
	struct vdec_resource_info dec_res_info;
	int input_driven;
 ...
 *
 * @dec_counter_lock: lock for accessing usage_counter
 * @usage_counter: counter for all normal priority task in queue
...
struct mtk_vcodec_dev {
...
#ifdef TV_INTEGRATION
	spinlock_t dec_counter_lock;
	int usage_counter[MTK_VDEC_HW_NUM][VDEC_PRIORITY_NUM];
#endif
	...
	struct notifier_block dec_pm_notifier;
	struct notifier_block enc_pm_notifier;
