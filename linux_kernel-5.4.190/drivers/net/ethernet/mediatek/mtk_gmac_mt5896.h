...
#define SIOC_SET_WOC_IPV6_CMD (SIOCDEVPRIVATE + 10)
...
#define WOC_PATTERN_CHECK_LEN_MAX 58

#define ETH_PROTOCOL_NUM_OFFSET 23
#define ETH_PROTOCOL_DEST_PORT_H_OFFSET 36
#define ETH_PROTOCOL_DEST_PORT_L_OFFSET 37
#define ETH_PROT_IPV6_NUM_OFFSET 20
#define ETH_PROT_IPV6_DEST_PORT_H_OFFSET 56
#define ETH_PROT_IPV6_DEST_PORT_L_OFFSET 57
...
struct mtk_dtv_gmac_reg_ops {
	...
	void (*phy_power_down)(struct net_device *ndev);
};
...
struct mtk_dtv_gmac_private {
	...
	u32 woc_ipv4_enable_bit;
	u32 woc_ipv6_enable_bit;
	...
	/* gmac use threaded-irq */
	u32 enable_threaded_irq;

	/* notifier */
	struct notifier_block reboot_notifier;

	u32 str_phy_power_down;
	bool is_from_phy_power_down;
