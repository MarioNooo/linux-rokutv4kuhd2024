...
#define abs_value_w_mask(value, mask) ((value & mask) >> (ffs(mask) - 1))
#define CID_2_EMI_MASK		0xe000/* [15:13] */
#define CID_2_SSC_MASK		0x1800/* [12:11] */
#define SMI_PORT_NUM_MASK	0x0700/* [10:8] */
#define CID_HW_ONLY_MASK	0x00ff/* [7:0] */
#define EMI_BIT_OFFSET	(ffs(CID_2_EMI_MASK) - 1)
#define SSC_BIT_OFFSET	(ffs(CID_2_SSC_MASK) - 1)
#define emi_ssc_sig_cal(emi, ssc) (((emi<<EMI_BIT_OFFSET) | (ssc<<SSC_BIT_OFFSET)) \
		>> SSC_BIT_OFFSET)
