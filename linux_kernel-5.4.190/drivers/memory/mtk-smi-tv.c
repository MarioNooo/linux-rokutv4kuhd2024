...
static u8
mtk_smi_larb_mt5873_bwl[MTK_LARB_NR_MAX][SMI_LARB_PORT_NR_MAX] = {
	{0x3f, 0x3f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f,
	0x1f, 0x1f, 0x3f, 0x3f, 0x1f}, /*larb0 13 ports*/
	{0x3f, 0x3f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f,
	 0x1f}, /*larb1 9 ports*/
	{0x3f, 0x3f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f}, /*larb2 7 ports*/
	{0x3f, 0x1f, 0x1f, 0x0f, 0x1f, 0x1f, 0x0f, 0x0f,
	 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x3f}, /*larb3 14 ports*/
	{0x3f, 0x3f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f,
	 0x1f, 0x1f, 0x1f, 0x1f, 0x1f}, /*larb4 13 ports*/
	{0x3f, 0x3f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f,
	 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f,
	 0x3f, 0x0f}, /*larb5 18 ports*/
	{0x3f, 0x3f, 0x0f, 0x0f, 0x0f, 0x0f, 0x3f, 0x0f,
	 0x0f, 0x0f, 0x3f, 0x3f, 0x3f, 0x0f, 0x0f, 0x0f,
	 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f,
	 0x0f, 0x0f, 0x0f, 0x0f, 0x3f, 0x3f, 0x3f}, /*larb6 31 ports*/
	{0x3f, 0x3f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f,
	 0x1f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f}, /*larb7 15 ports*/
	{0x3f, 0x3f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f, 0x1f,
	 0x3f, 0x3f, 0x1f}, /*larb8 11 ports*/
	{0x3f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f,
	 0x0f, 0x0f}, /*larb9 10 ports*/
	{0x3f,  0x3f, 0x0f, 0x3f, 0x3f, 0x0f, 0x3f, 0x3f}, /*larb10 8 ports*/
	{}, /*larb11 0 ports*/
	{0x3f, 0x3f, 0x0f, 0x0f}, /*larb 12 4 ports*/
};
...
static const struct mtk_smi_larb_gen mtk_smi_larb_mt5873 = {
	.port_in_larb_gen2 = {13, 9, 7, 14, 13, 18,
			      31, 15, 11, 10, 8, 0, 4},
	.has_gals                   = false,
	.config_port                = mtk_smi_larb_config_port_gen2_general,
	.has_bwl                    = true,
	.bwl                        = (u8 *)mtk_smi_larb_mt5873_bwl,
};
...
static const struct of_device_id mtk_smi_larb_of_ids[] = {
	...
	{
		.compatible = "mediatek,mt5873-smi-larb",
		.data = &mtk_smi_larb_mt5873
	},
	{
...
int mtk_smi_larb_ostdl(u32 larb, u32 port, u32 ostdl)
{
	...
	if (!larb_data || port >= larb_data->port_in_larb_gen2[larb]) {
...
static u16 mtk_smi_common_mt5873_bwl[SMI_COMMON_NR_MAX][SMI_COMMON_LARB_NR_MAX] = {
	{0x17cb, 0x1823, 0x118e, 0x1650, 0x0000, 0x1100, 0x0000, 0x0000},
	{0x1100, 0x1100, 0x1100, 0x141e, 0x1100, 0x1100, 0x1103, 0x0000},
	{0x1209, 0x1100, 0x0000, 0x0000, 0x0000, 0x16b5, 0x0000, 0x1fff},
};
...
static struct mtk_smi_reg_pair
mtk_smi_common_mt5873_misc[SMI_COMMON_NR_MAX][SMI_COMMON_MISC_NR] = {
	{
	{SMI_L1LEN, 0xa}, {ADDR_DUMMY, 0x0}, {SMI_FIFO_TH1, 0x02020405},
	{SMI_FIFO_TH2, 0x02020405}, {ADDR_DUMMY, 0x0}, {ADDR_DUMMY, 0x0},
	},
	{
	{SMI_L1LEN, 0xa}, {ADDR_DUMMY, 0x0}, {SMI_FIFO_TH1, 0x02020405},
	{ADDR_DUMMY, 0x0}, {ADDR_DUMMY, 0x0}, {ADDR_DUMMY, 0x0},
	},
	{
	{SMI_L1LEN, 0xa}, {ADDR_DUMMY, 0x0}, {SMI_FIFO_TH1, 0x02020405},
	{ADDR_DUMMY, 0x0}, {ADDR_DUMMY, 0x0}, {ADDR_DUMMY, 0x0},
...
static const struct mtk_smi_common_plat mtk_smi_common_mt5873 = {
	.gen      = MTK_SMI_GEN2,
	.has_gals = false,
	.bus_sel  = false,
	.has_bwl  = true,
	.bwl      = (u16 *)mtk_smi_common_mt5873_bwl,
	.misc     = (struct mtk_smi_reg_pair *)mtk_smi_common_mt5873_misc,
};
...
static const struct of_device_id mtk_smi_common_of_ids[] = {
	...
	{
		.compatible = "mediatek,mt5873-smi-common",
		.data = &mtk_smi_common_mt5873,
	},
	{
...
static int __maybe_unused mtk_smi_common_resume(struct device *dev)
{
	...
	int i, ret;
	struct mtk_smi_reg_pair *misc = common->plat->misc;
	int common_id = common->common_id;
	...
	if (common->plat->gen != MTK_SMI_GEN2 || !common->plat->has_bwl)
		return 0;
	for (i = 0; i < SMI_COMMON_LARB_NR_MAX; i++)
		writel_relaxed(common->plat->bwl[common_id * SMI_COMMON_LARB_NR_MAX + i],
			common->base + SMI_L1ARB(i));
	for (i = 0; i < SMI_COMMON_MISC_NR && misc; i++) {
		if (misc[common_id * SMI_COMMON_MISC_NR + i].offset > 0) {
			writel_relaxed(misc[common_id * SMI_COMMON_MISC_NR + i].value,
				common->base + misc[common_id * SMI_COMMON_MISC_NR + i].offset);
		}
	}
#endif
	wmb(); /* make sure settings are written */
