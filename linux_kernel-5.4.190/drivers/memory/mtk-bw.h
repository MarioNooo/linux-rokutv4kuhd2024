...
#define RIU2CPU_ADDR(riu_base)		(0x1c000000 + (riu_base * 0x200))
...
#define PERMILLAGE(numer, denom)	bw_div(((numer) * 1000), (denom))
#define PERMILLAGE_ALIGN(numer)		bw_div((numer), (1000))
#define NORMALIZE_PERC(number)		((number) > 100 ? 100 : number)
#define BEAT_TO_BYTE		(16)
...
#define CAL_TOTAL_BW(width, clock)	\
	(width/8 * clock)
#define CAL_WARNING_BW_RATIO(penalty)	\
	(penalty-10)
#define PSEC_PER_USEC		1000000L
#define EFFI_MON_DELAY_CNT		(50)
#define EFFI_MON_DELAY_PATCH_CNT	(500)
#define EFFI_MON_DELAY_TIME_MAX		(1001)
#define EFFI_MON_DELAY_TIME_MIN		(999)
#define FAKE_ENG_DELAY_TIME_MAX		501
#define FAKE_ENG_DELAY_TIME_MIN		499
#define FAKE_ENG_TIME_OUT		100
...
#define MT5879_SMI_CLK		(456)
#define MT5876_SMI_CLK		(432)
...
#define EMI_EFFI_MON_CNT		(8)
#define EFFI_MON_CNT			(14)
#define EFFI_BURST_SET_CNT		(8)
#define EFFI_BURST_SET_MT5876_NUM	(4)
...
#define SMI_MON_AXI_BEA_CNT	(0x1CC)
...
#define REG_MONITOR_HIT_BOUND	(0x34)

#define REG_MONITOR_CLN_OUT_SLE	(0xffffff3f)
...
#define TEST_MODE_OLD			(0x1C)
#define TEST_MODE			(0x20)

#define FAKE_ENG_LOOP			(4)

/* FIFO STATUS OFFSET REG */
#define REG_TH_DYM_ULTRA		(0x54)
#define REG_TH_URGENT			(0x58)
#define REG_FORCE_CLOCK			(0x100)
#define REG_ACTIVE			(0x140)
#define REG_READBACK			(0x1c0)
#define REG_STATUS			(0x1c8)

/* FIFO STATUS BIR REG */
#define RB_ENABLE			(0)
#define NOT_DONE			(2)
#define FORCE_CLK			(4)
#define FILED_TH_PREULTRA		(0x7f)
#define MASK_PREULTRA			(0x80)
#define FILED_TH_ULTRA			(0x7f00)
#define MASK_ULTRA			(0x8000)
#define FILED_TH_URGENT			(0x7f)
#define MASK_URGENT			(0x80)
...
#define EMI_MON_WO		0xAAAAAAAA
#define EMI_MON_RO		0x55555555
#define RSHIFT_8BIT(val)	((val) >> 8)
...
#define LARB_MODULE_LIST_PRINT	(3)

#define GET_LARB_NUM	(0)
#define GET_COMM_NUM	(1)

#define CEN_EMI(id)	id
#define EFFI_MON(id)	id
#define NULL_EFFI_ID	EFFI_MON(99)
...
struct group_bw {
	u64	group_bw_vdec;
	u64	group_bw_display;
	u64	group_bw_memc;
	u64	group_bw_cpu;
	u64	group_bw_graphic;
	u64	group_bw_aud;
	u64	group_bw_others;
};
...
struct fifo_status {
	...
	unsigned int	not_done_cnt;
	unsigned int	th_preultra;
	unsigned int	th_ultra;
	unsigned int	th_urgent;
	bool		mask_preultra;
	bool		mask_ultra;
	bool		mask_urgent;
};
...
enum merak_effi_table {
	MT5896_EFFI_LPDDR4_4266 = 0,
	MT5896_EFFI_CNT,
	MT5876_EFFI_PCDDR4_2666 = 0,
	MT5876_EFFI_PCDDR4_3200 = 1,
	MT5876_EFFI_PCDDR3_2133 = 2,
	MT5876_EFFI_CNT,
	MT5879_EFFI_PCDDR4_2666 = 0,
	MT5879_EFFI_PCDDR4_3200 = 1,
	MT5879_EFFI_CNT,
	MT5873_EFFI_PCDDR4_3200 = 0,
	MT5873_EFFI_CNT,
};
