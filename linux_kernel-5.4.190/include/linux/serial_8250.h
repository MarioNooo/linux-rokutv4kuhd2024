...
#define MSR_SAVE_FLAGS UART_MSR_ANY_DELTA
	...
	struct uart_8250_em485 *em485;
        ...
        wait_queue_head_t loopback_wq;
        unsigned char  *loopback_buf;
        unsigned        loopback_windex;
        bool            loopback_wrapped;
        struct cdev     cdev;
#endif
#ifdef CONFIG_ROKU_SERIAL_8250
        unsigned int    uart_noinput:1;
        unsigned int    uart_nooutput:1;
        unsigned int    uart_in_dl_write:1;
#endif
