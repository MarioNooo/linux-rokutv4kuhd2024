/* MTK: This file is copied from
 * https://android.googlesource.com/platform/bionic/+/master/libc/kernel/android/uapi/linux/compiler.h
 * ONLY ANDROID BIONIC UAPI has this!!!!
 */
