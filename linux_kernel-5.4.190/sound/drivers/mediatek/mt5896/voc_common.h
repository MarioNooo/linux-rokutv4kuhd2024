...
//  Macros
//------------------------------------------------------------------------------
#define ENABLE_SYNC_BY_TIMER2   (1)
...
#define VOICE_SW_CONFIG_OFFSET         (0x51 * 4)
#define VOICE_SW_CONFIG_CM4_DISABLE    (1<<7)

//Time
#define VOICE_SECOND_PER_MINUTE    60
#define VOICE_MS_PER_SECOND        1000
#define VOICE_US_PER_MS            1000
#define VOICE_NS_PER_US            1000
#define VOICE_NS_PER_MS            (1000 * 1000)
#define VOICE_US_PER_SECOND        (VOICE_MS_PER_SECOND * VOICE_US_PER_MS)
#define VOICE_NS_PER_SECOND        (VOICE_US_PER_SECOND * VOICE_NS_PER_US)
#define VOICE_MS_PER_MINUTE        (VOICE_SECOND_PER_MINUTE * VOICE_MS_PER_SECOND)
#define VOICE_US_PER_MINUTE        (VOICE_MS_PER_MINUTE * VOICE_US_PER_MS)

//Pad mux
#define VOICE_PINCTRL_NAME_PDM      "voc_pin_pdm"
#define VOICE_PINCTRL_NAME_I2S      "voc_pin_i2s"
#define VOICE_PINCTRL_NAME_I2S_TDM  "voc_pin_i2s_tdm"
//------------------------------------------------------------------------------
// Enumerate
//------------------------------------------------------------------------------
enum {
...
enum {
	VOC_MIC_INPUT_PDM = 0,
	VOC_MIC_INPUT_I2S_RX_MASTER,
	VOC_MIC_INPUT_I2S_RX_SLAVE,
	VOC_MIC_INPUT_I2S_TDM_RX_MASTER,
	VOC_MIC_INPUT_I2S_TDM_RX_SLAVE,
	VOC_MIC_INPUT_MAX,
};

enum {
	VOC_CMD_SET_MIC_INPUT_MUX = 0,
	VOC_CMD_SET_MAX,
};
