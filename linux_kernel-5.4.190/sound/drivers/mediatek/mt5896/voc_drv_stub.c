...
//==============================================================================
static int voc_drv_stub_get_handler(uint8_t cmd, void *params)
{
	UNUSED(cmd);
	UNUSED(params);
	return 0;
...
//==============================================================================
static int voc_drv_stub_set_handler(uint8_t cmd, void *params)
{
	UNUSED(cmd);
	UNUSED(params);
	return 0;
...
static struct voc_communication_operater voc_stub_op = {
	...
	.get = voc_drv_stub_get_handler,
	.set = voc_drv_stub_set_handler,
};
