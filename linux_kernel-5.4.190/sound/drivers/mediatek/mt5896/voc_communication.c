...
int voc_communication_get(uint8_t cmd, void *params)
{
	if ((!voc_communication_op) || (!voc_communication_op->get))
		return -EINVAL;

	return voc_communication_op->get(cmd, params);
}

int voc_communication_set(uint8_t cmd, void *params)
{
	if ((!voc_communication_op) || (!voc_communication_op->set))
		return -EINVAL;

	return voc_communication_op->set(cmd, params);
}
