...
#define MIX_DSP_AEC_PATH_SEL_DEC_SRC_OUT_8ch         (9)
#define MIX_DSP_AEC_PATH_SEL_ENC_FRONT_END_8ch       (10)

#define MIX_DSP_ADC1_PATH_SHIFT        (4)
#define MIX_DSP_ADC1_PATH_MASK         (0xF0)
#define MIX_DSP_ADC2_PATH_MASK         (0x0F)
#define MIX_DSP_ADC_AUMIC_PATH         (0x07)
...
#define CAP_SOURCE_IDX0         (0)
#define CAP_SOURCE_IDX1         (1)
#define CAP_SOURCE_IDX2         (2)
#define CAP_SOURCE_IDX3         (3)
//------------------------------------------------------------------------------
...
enum {
	...
	LOOPBACK_REG_PCM_CHANNEL_LAYOUT,
	LOOPBACK_REG_LEN,
};

enum {
	LOOPBACK_FROM_SPEAKER = 0,
	LOOPBACK_FROM_ADC2,
	LOOPBACK_FROM_ADC1,
	LOOPBACK_FROM_I2S_RX_2CH,
	LOOPBACK_FROM_I2S_RX_4CH,
	LOOPBACK_FROM_I2S_RX_8CH,
	LOOPBACK_FROM_DIGITAL_OUT_8CH,
	LOOPBACK_FROM_MAX,
};
...
struct mtk_snd_loopback {
	...
	bool loopback_pcm_sw_running;
	bool loopback_pcm_sw_running_stopped;
